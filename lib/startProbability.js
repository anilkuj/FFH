 ...
 * playing anyway.
 *
 * Position is FPL's coarse GKP/DEF/MID/FWD bucket, not role-specific (e.g. centre-back vs
 * fullback) -- finer-grained real data isn't available, so this can pair a vacancy with a
 * candidate who isn't a true like-for-like replacement. Accepted limitation, not a bug.
 *
