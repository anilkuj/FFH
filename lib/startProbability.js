 ...
 * playing anyway.
 *
 * If two simultaneous vacancies at the same position would select the same beneficiary, the result
 * reflects whichever is processed last (input order), not the largest gap or most-recent injury --
 * a deliberate choice, not an oversight (see the corresponding test below).
 *
