...
export function renderTransferPlanner(container, state, actions) {
    ...
    tpImportBtn.addEventListener('click', async () => {
        ...
        try {
            ...
            tempCaptain = currentGwCaptain;
            tempVice = currentGwVice;
            tempBank = latestBankVal;
            ...
            state.drafts[0].squadSlots = currentGwSlots;
            state.drafts[0].captain = currentGwCaptain;
